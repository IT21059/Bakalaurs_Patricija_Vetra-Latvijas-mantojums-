import 'package:flutter/material.dart'; //šī funkcija izveido lapu, kur lietotājs var pievienot jaunus atrastus vēstures objektus. Atveras forma, kuru aizpilda pareizi, ieliek ķeksīti un tad nospiež sūtīt
import 'package:http/http.dart' as http; //kad aizpilda formu, dati tiek nosūtīti uz rediģētāja google forms, kur tālāk atsūta atbildi epastā lietotājam, cik ilgi paies laiks, kamēr tiks pievienots jauns objekts un vai ir akceptēts.
// rediģētājs pats pievieno objektu sistēmā.
...
class _AddObjectPageState extends State<AddObjectPage> { //formas validēšanas atslēga
  final _formKey = GlobalKey<FormState>();
//teksta lauku kontrolieri
  final _titleController = TextEditingController();
  final _mainTextController = TextEditingController();
  final _linkController = TextEditingController();
  final _nameController = TextEditingController();
  final _emailController = TextEditingController();
//lietotāja piekrišanas ķeksītis
  bool _consentChecked = false;
  bool _sending = false;

static const String _formUrl = //google forms post url
 ...
 //validēšanas funkcijas tika labotas ar MI palīdzību
  String? _requiredValidator(String? value, String fieldName) { //obligātie lauki
  ...
  String? _emailValidator(String? value) { //epasta validācija
    if (value == null || value.trim().isEmpty) {
...
//_submitForm() funckija tika labota ar MI palīdzību
  Future<void> _submitForm() async { //formas aizsūtīšana uz google forms
    if (!_formKey.currentState!.validate()) return;

    if (!_consentChecked) { //pārbaude vai lietotājs ir piekritis
    ...
    try { //nosūta post pieprasījumu uz google forms
...
//notīras forma
        ...
        ScaffoldMessenger.of(context).showSnackBar( //ja nebija sekmīgi, to parāda
          SnackBar(
            content: Text(
      ...
      if (!mounted) return; //atjauno stāvokli
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                controller: _titleController, //objekta nosaukums
...
TextFormField(
  controller: _mainTextController, //pilnais apraksts
  ...
  validator: (value) =>
      _requiredValidator(value, 'Pilnais apraksts'),
              ...
              const SizedBox(height: 12),
              //šī daļa tika labota ar MI palīdzību
              ElevatedButton.icon( //nosūtīšanas poga
