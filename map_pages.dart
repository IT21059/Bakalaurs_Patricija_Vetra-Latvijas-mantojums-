...
// 🔹 CIDOC CRM kodi priekš īpašībām
String _getPropertyCode(String field) {
  switch (field) {
    ...
    case 'related':
      return 'P67_refers_to';
    case 'object':
      return 'E22_Human-Made_Object';
    default:
      return '';
  }
}
...
class _MapPageState extends State<MapPage> {
  ...
  Future<void> _loadObjectsFromFuseki() async {
    try {
  ...
  Future<void> _toggleRadius() async {
    if (currentLocation == null) {
      final ok = await _getCurrentLocation();
      if (!ok) return;
    }
  ...
  Future<void> _openCreatorInfo(String creatorUri) async {
